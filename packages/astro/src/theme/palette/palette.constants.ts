...
export const PALETTE_SEMANTICS: PaletteSemantic = {
  ...
  stone: {
    light: {
      contrast: colors.white,
      fg: colors.stone["700"],
      subtle: colors.stone["200"],
      muted: colors.stone["300"],
  ...
  mauve: {
    light: {
      contrast: colors.white,
      fg: colors.mauve["700"],
      subtle: colors.mauve["200"],
      muted: colors.mauve["300"],
      emphasized: colors.mauve["300"],
      solid: colors.mauve["700"],
      focusRing: colors.mauve["400"],
      border: colors.mauve["500"],
    },
    dark: {
      contrast: colors.black,
      fg: colors.mauve["300"],
      subtle: colors.mauve["800"],
      muted: colors.mauve["700"],
      emphasized: colors.mauve["700"],
      solid: colors.mauve["50"],
      focusRing: colors.mauve["400"],
      border: colors.mauve["400"],
    },
  },
  olive: {
    light: {
      contrast: colors.white,
      fg: colors.olive["700"],
      subtle: colors.olive["200"],
      muted: colors.olive["300"],
      emphasized: colors.olive["300"],
      solid: colors.olive["700"],
      focusRing: colors.olive["400"],
      border: colors.olive["500"],
    },
    dark: {
      contrast: colors.black,
      fg: colors.olive["300"],
      subtle: colors.olive["800"],
      muted: colors.olive["700"],
      emphasized: colors.olive["700"],
      solid: colors.olive["50"],
      focusRing: colors.olive["400"],
      border: colors.olive["400"],
    },
  },
  mist: {
    light: {
      contrast: colors.white,
      fg: colors.mist["700"],
      subtle: colors.mist["200"],
      muted: colors.mist["300"],
      emphasized: colors.mist["300"],
      solid: colors.mist["700"],
      focusRing: colors.mist["400"],
      border: colors.mist["500"],
    },
    dark: {
      contrast: colors.black,
      fg: colors.mist["300"],
      subtle: colors.mist["800"],
      muted: colors.mist["700"],
      emphasized: colors.mist["700"],
      solid: colors.mist["50"],
      focusRing: colors.mist["400"],
      border: colors.mist["400"],
    },
  },
  taupe: {
    light: {
      contrast: colors.white,
      fg: colors.taupe["700"],
      subtle: colors.taupe["200"],
      muted: colors.taupe["300"],
      emphasized: colors.taupe["300"],
      solid: colors.taupe["700"],
      focusRing: colors.taupe["400"],
      border: colors.taupe["500"],
    },
    dark: {
      contrast: colors.black,
      fg: colors.taupe["300"],
      subtle: colors.taupe["800"],
      muted: colors.taupe["700"],
      emphasized: colors.taupe["700"],
      solid: colors.taupe["50"],
      focusRing: colors.taupe["400"],
      border: colors.taupe["400"],
    },
  },
};
